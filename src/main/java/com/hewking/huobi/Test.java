...
//        String urlbalanceStr = BASE_URL +"/v1/account/accounts/113952/balance?"+ apkKeyGet(params,"/v1/account/accounts/113952/balance");
        ...
        com.hewking.huobi.HttpUtils.doGetAsyn(url, new com.hewking.huobi.HttpUtils.CallBack() {
            @Override
    ...
    public static String BASE_URL = "https://api.com.hewking.huobi.pro";

    public static String HOST_NAME = "api.com.hewking.huobi.pro";
