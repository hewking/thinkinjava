...
//        appendDate(file,"excption")
    ...
    @NotNull fun readText(file : File) : String{
    ...
    @NotNull fun indexEnd(file : File ,filter : OnEndListener) : Long{
    ...
    @NotNull fun readFromEnd(file : File,filter : OnEndListener) : String {
        val baos = ByteArrayOutputStream()
    ...
    @NotNull fun indexEnd2(file: File,filter: OnEndListener) : Long{
